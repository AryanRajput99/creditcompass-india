...
const CATEGORY_SEO: Record<string, { title: string; description: string; heading: string; subheading: string }> = {
  ...
  travel: {
    title: 'Best Travel Credit Cards in India 2026 — Airport Lounge & Air Miles',
  ...
  fuel: {
    title: 'Best Fuel Credit Cards in India 2026 — Surcharge Waiver',
  ...
  shopping: {
    title: 'Best Shopping Credit Cards in India 2026 — Amazon, Flipkart Offers',
  ...
  premium: {
    title: 'Best Premium Credit Cards in India 2026 — Luxury Benefits',
  ...
  business: {
    title: 'Best Business Credit Cards in India 2026',
  ...
  student: {
    title: 'Best Student Credit Cards in India 2026 — Easy Approval',
  ...
  rewards: {
    title: 'Best Rewards Credit Cards in India 2026 — Earn & Redeem Points',
